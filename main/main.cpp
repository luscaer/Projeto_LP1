...
//                                         case 1:{
//                                             if(existePD == false){
//                                                 cout << "cadastrando Product Owner" << endl;
//                                                 existePD = true;
//                                             }else{
//                                                 cout << "Já existe um Product Owner" << endl;
//                                             }
...
//                                         case 2:{
//                                             if(existeSM == false){
//                                                 cout << "cadastrando Scrum Master" << endl;
//                                                 existeSM = true;
//                                             }else{
//                                                 cout << "Já existe um Scrum Master" << endl;
//                                             }
...
//                                         //cadrastar Devs
//                                         case 3:{
//                                             cout << "cadastrando Desenvolvedor" << endl;
//                                             if(existeDev == false) existeDev = true;
...
//                                         case 4:{
//                                             if(existeT == false){
//                                                 cout << "cadastrando Tester" << endl;
//                                                 existeT = true;
//                                             }else{
//                                                 cout << "Já existe um Tester" << endl;
//                                             }
...
//                                 case 2:
//                                     if(existeMembros == true) cout << "Listando membros" << endl;
...
//                                 case 3:{
//                                     if(existeBacklog){
//                                         if(existeMembros == true) cout << "Listando tarefas....." << endl;
//                                         else cout << "Não existe membros cadastrados" << endl;
//                                         break;
//                                     }else{
...
//                                                             case 2:{
//                                                                 if(existeBacklog == false){
//                                                                     cout << "Inicializando Backlog..." << endl;
//                                                                     existeBacklog = true;
//                                                                 }
